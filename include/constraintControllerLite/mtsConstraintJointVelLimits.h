...
#ifndef mtsConstraintJointVelLimits_H
#define mtsConstraintJointVelLimits_H

#include <constraintControllerLite/mtsConstraintBase.h>
#include <sawConstraintController/prmKinematicsState.h>

class mtsConstraintJointVelLimits : public mtsConstraintBase
{
public:
...
private:
    bool check_limit_input(const vctDoubleVec &limits)
    {
        ...
        {
            std::cerr << "[mtsConstraintJointVelLimits]: Given input size: " << limits.size() << " does not match number of joints: " << num_joints << std::endl;
            return 0;
        }
        return 1;
    }
...
#endif // mtsConstraintJointVelLimits_H
